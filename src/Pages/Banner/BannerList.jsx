...
function BannerList() {
  ...
  const imageBodyTemplate = (rowData) => {
    return <Image src={rowData.gallery ? rowData.gallery.medias.filter(x=>x.mediaFormat.code==='superzoom')[0].absolutePath :'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png' }
                  zoomSrc={rowData.gallery ? rowData.gallery.medias.filter(x=>x.mediaFormat.code==='superzoom')[0].absolutePath :'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png' }
                  width="100"
                  height="100"
  ...
  const verifiedBodyTemplate = (rowData) => {
    return <i style={rowData.active ? { color: 'green' }:{ color: 'red' }} className={classNames('pi', {'true-icon pi-check-circle': rowData.active, 'false-icon pi-times-circle': !rowData.active})}></i>;
}
      ...
      <div className="col-12">
        <div className="card">
          ...
          >
            ...
            <Column field="active" header="Durumu" body={verifiedBodyTemplate}></Column>
          </DataTable>
        </div>
      </div>
    </div>
