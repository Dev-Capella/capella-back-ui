...
export default function ProductList() {
  ...
  const imageBodyTemplate = (rowData) => {
    return <Image src={rowData.galleries.length>0 ? rowData.galleries[0].medias[0].absolutePath :'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png' }
                  zoomSrc={rowData.galleries.length>0 ? rowData.galleries[0].medias[1].absolutePath :'https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png' }
                  width="80"
                  height="80"
