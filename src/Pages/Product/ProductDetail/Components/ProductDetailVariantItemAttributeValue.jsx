...
export default function ProductDetailVariantItemAttributeValue({
  ...
  useEffect(()=>{
    ...
    setValue("classifications",variantItems[selectedVariantItemIndex]?.classifications)
  },[])
